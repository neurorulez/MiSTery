...
l21: # 
						...
						//../DeMiSTify/firmware/ps2.c, line 90
						// (bitwise/arithmetic) 	//ops: 5, 0, 2
						// (obj to r1) flags 42 type 3
						// reg r4 - only match against tmp
	mt	r4
	...
	.lipcrel	l25
		add	r7
						...
						//../DeMiSTify/firmware/ps2.c, line 92
						//FIXME convert
						//Converting to wider type...
						//But unsigned, so no need to extend
						// (prepobj r0)
	...
	.lipcrel	l25
		add	r7
						...
						//../DeMiSTify/firmware/ps2.c, line 94
						//FIXME convert
						//Converting to wider type...
						//But unsigned, so no need to extend
						// (prepobj r1)
...
l25: # 
						...
						//../DeMiSTify/firmware/ps2.c, line 101
						// (a/p assign)
						// (prepobj r0)
 						// reg r3 - no need to prep
						// (obj to tmp) flags 21 type 3
...
l27: # 
	...
	.lipcrel	l31
		add	r7
						...
						//../DeMiSTify/firmware/ps2.c, line 111
						//FIXME convert
						//Converting to wider type...
						//But unsigned, so no need to extend
						// (prepobj r1)
...
//Disposable, postinc doesn't matter.
	...
	st	r0
						...
						//../DeMiSTify/firmware/ps2.c, line 112
						//FIXME convert
						//Converting to wider type...
						//But unsigned, so no need to extend
						// (prepobj r0)
